...
window.addEventListener('message', function (event) {
    ...
    switch (e.type) {
        ...
        case "OpenReception":
            ...
            $.post('http://Sam_motels/Cal', JSON.stringify({}))
...
$(document).on('click', '#PutVehicle', function(){
    ...
    $.post('http://Sam_motels/Cal', JSON.stringify({}));
    $.post('http://Sam_motels/PutVehicleGarage', JSON.stringify({
...
$(document).on('click', '#yatirBaba', function(){
    ...
    if ((input !== '') || (parseInt(input) > 0)){
        $.post('http://Sam_motels/DepositMotelCase', JSON.stringify({
            mcode: SecilenMotelMCode,
            money: input,
            type: Tarz
        }))
...
$(document).on('click', '#orospuogluadez', function() {
    ...
    $.post('http://Sam_motels/UpdateMotelCorridorColor', JSON.stringify({
        color : SecilenRenk,
        mcode: SecilenMotelMCode,
...
$(document).on('click', '#necmettinErbakan', function() {
    ...
    $(this).addClass('SelectTV');
    SecilenRenk = $(this).attr("data-fex")
    $.post('http://Sam_motels/UpdateMotelGarageColor', JSON.stringify({
        color : SecilenRenk,
        mcode: SecilenMotelMCode,
    }))
});
...
$(document).on('click', '#feedbackDelete', function(){
    $.post('http://Sam_motels/DeleteFeedback', JSON.stringify({
        mcode: SecilenMotelMCode,
        id: $(this).attr("xaas")
    }))
});
...
$(document).on('click', '#signBaba', function(){
    ...
    $.post('http://Sam_motels/CloseUI', JSON.stringify({}))
});

$(document).on('click', '.resetOwnerButton', function(){
    $.post('http://Sam_motels/KickAllRooms', JSON.stringify({
        mcode: SecilenMotelMCode
    }))
});
...
LoadColors = function(data) {
    ...
    $('.Rog-Item').click(function() {
        ...
        $.post('http://Sam_motels/LoadRoomTheme', JSON.stringify({
            color : SecilenRenk,
...
$(document).on('click', '#GiveKey', function(){
    ...
    $.post('http://Sam_motels/GiveMotelCardKey', JSON.stringify({
        room: $(this).attr("room"),
...
$(document).on('click', '#RemoveKey', function(){
    $.post('http://Sam_motels/RemoveKeyByCid', JSON.stringify({
        mcode: $(this).attr("mCode"),
...
$(document).on('click', '#LoadKeyRoom', function(){ 
   $.post('http://Sam_motels/LoadSelectedKeyRoom', JSON.stringify({
        mcode: $(this).attr("mcode"),
        rcode:  $(this).attr("rcode"),
...
$(document).on('click', '#PayInvoice', function(){
    ...
    $.post('http://Sam_motels/PayInvoice', JSON.stringify({
        amount: OdeyecekBaba,
...
$(document).on('click', '#PayUzat', function(){
    if(Uzatabilir == true){
        $.post('http://Sam_motels/UzatOdaZaman', JSON.stringify({
...
$(document).on('click', '#Yukselt', function(){
    ...
    $.post('http://Sam_motels/UpdateStashWeight', JSON.stringify({
        mcode: SecilenMotelMCode,
...
$(document).on('click', '#ChangeRoomKey', function(){
    $.post('http://Sam_motels/ChangeRoomKey', JSON.stringify({
        mcode: SecilenMotelMCode,
...
$(document).on('click', '#CopyRoomKey', function(){
    $.post('http://Sam_motels/CopyRoomKey', JSON.stringify({
        mcode: SecilenMotelMCode,
        room: $(this).attr("roomid"),
        rcode: $(this).attr("rcode")
    }))
...
$(document).on('change', '#satt input[type="checkbox"]', function() {
    $.post('http://Sam_motels/ChangeRoomPaymenType', JSON.stringify({
...
$(document).on('click', '#UzatKira', function(){
    ...
    $.post('http://Sam_motels/RoomRentUzat', JSON.stringify({
        roomid: RoomId,
        mcode: SecilenMotelMCode,
    }))
});
...
$(document).on('click', '#OdaIptal', function(){
    var RoomId = $(this).attr("data-id");
    $.post('http://Sam_motels/LeaveMotelRoom', JSON.stringify({
        roomid: RoomId,
        mcode: SecilenMotelMCode,
    }))
});
...
$(document).on('click', '#transferownership', function(){
    $.post('http://Sam_motels/TranferMotelOwnership', JSON.stringify({
        mcode: SecilenMotelMCode
    }))
});
...
$(document).on('click', '#faadback', function(){
    if ((StartPoint >= 1) || (SelectedFeedbackRoom !== null)){
        $.post('http://Sam_motels/CreateFeedback', JSON.stringify({
...
$(document).on('click', '#BuyMotelRoom', function(){
    if(SeciliOda !== null){
        $.post('http://Sam_motels/RentMotelRoom', JSON.stringify({
...
$(document).on('click', '.motelAdmin', function(){
    $('#ReceptionContainer').fadeOut(350);
    $.post('http://Sam_motels/OpenBossMenu', JSON.stringify({
        id: OpenedMotel
    }))
});
...
$(document).on('click', '#BakOdalara', function(){
    ...
    $('#menurece').hide();
    $.post('http://Sam_motels/LoadSelectedRoomTypeRooms', JSON.stringify({
        room: RoomID,
        motelid: OpenedMotel
    }))
});
...
$(document).on('click', '#BuyMotel', function(){
    $.post('http://Sam_motels/BuyBusinessMotel', JSON.stringify({
        id: OpenedMotel
    }))
});
...
$(document).on('click', '.odalarCaylaar', function(){
    ...
    $.post('http://Sam_motels/LoadRoomInterior', JSON.stringify({
        mcode: SecilenMotelMCode,
...
$(document).on('click', '#roomDoorHash', function(){
    $('.NewEditMenu').fadeOut(350);
    $.post('http://Sam_motels/OpenRoomMLOEditor', JSON.stringify({}))
});

$(document).on('click', '#EditorRoomEnter', function(){
    $('.NewEditMenu').fadeOut(350);
    $.post('http://Sam_motels/EnterRoomCoord2', JSON.stringify({}))
});

$(document).on('click', '#EnterStashCoord', function(){
    $('.NewEditMenu').fadeOut(350);
    $.post('http://Sam_motels/EnterStashCoord', JSON.stringify({}))
});

$(document).on('click', '#WardrobeCoordEnter', function(){
    $('.NewEditMenu').fadeOut(350);
    $.post('http://Sam_motels/WardrobeCoordEnter', JSON.stringify({}))
});
...
$(document).on('click', '#GiveKeyPlayer', function(){
    $.post('http://Sam_motels/GivePlayerKeyCard', JSON.stringify({
        mcode: $(this).attr("mcode"),
        room: $(this).attr("room"),
        name: $(this).attr("name"),
...
$(document).on('click', '#OpenApartment', function(){
    ...
    $.post('http://Sam_motels/SetV', JSON.stringify({}))
});
...
$(document).on('click', '#GirKat', function(){
    $('#ElevatorMenu').fadeOut(200);
    elevatorMenuIn = false
    $.post('http://Sam_motels/SetPlayerKat', JSON.stringify({
        asd: $(this).attr("kat"),
...
$(document).on('click', '#GirKatGarage', function(){
    $('#ElevatorMenu').fadeOut(200);
    elevatorMenuIn = false
    $.post('http://Sam_motels/SetPlayerGarage', JSON.stringify({
        asd: $(this).attr("kat"),
        between: $(this).attr("hayk"),
        between2: $(this).attr("mayk"),
        mcode: SecilenMotelMCode
...
$(document).on('click', '#EnterGarage', function(){
    $('#ElevatorMenu').fadeOut(200);
    elevatorMenuIn = false
    $.post('http://Sam_motels/EnterGarage', JSON.stringify({
        asd: $(this).attr("kat"),
        between: $(this).attr("hayk"),
        between2: $(this).attr("mayk"),
        mcode: SecilenMotelMCode
...
$(document).on('click', '#LeaveCo', function(){
    elevatorMenuIn = false
    $('#ElevatorMenu').fadeOut(200);
    $.post('http://Sam_motels/LeaveCorridor', JSON.stringify({}))
});
...
$(document).on('click', '#LeaveCoV', function(){
    ...
    $('#ElevatorMenu').fadeOut(200);
    $.post('http://Sam_motels/CloseUI', JSON.stringify({}))
    $.post('http://Sam_motels/LeaveGarage', JSON.stringify({}))
});

$(document).on('click', '#ekleYeniKat', function(){
    $.post('http://Sam_motels/AddNewFloor', JSON.stringify({
        mcode: SecilenMotelMCode
    }))
});
...
$(document).on('click', '#editRoom', function(){
    ...
    $.post('http://Sam_motels/LoadSelectedMotelRoomData', JSON.stringify({
        id: $(this).attr("data"),
        mcode: SecilenMotelMCode
    }))
});
...
$(document).on('click', '#CreateNewHotel', function(){
    ...
    if (setMotelName !== ""  && setMotelPrice !== ""  && setReceptionCoords.startsWith("vector3") && setGarageCoords !== ""){
        $.post('http://Sam_motels/CreateHotel', JSON.stringify(DataMotel));
        $('#NewMotelScreen').fadeOut(350);
    } else {
        showNotifyV({
            title: Lang["Error"],
...
$(document).on('click', '#HotelReceptionCopy', function(){
    $('.NewEditMenu').fadeOut(350);
    $.post('http://Sam_motels/SetReceptionCoords', JSON.stringify({}))
});

$(document).on('click', '#HotelGarageCopy', function(){
    $('.NewEditMenu').fadeOut(350);
    $.post('http://Sam_motels/SetGarageCoords', JSON.stringify({}))
});

SelectMotel = function(){
    $.post('http://Sam_motels/LoadSelectedMotel', JSON.stringify({
        mcode: $(this).attr("mcode")
    }))
}
...
MotelOwnerChange = function(){
    $('#MotelAdminMenu').fadeOut(350);
    $.post('http://Sam_motels/AllPlayers', JSON.stringify({
        mcode: $(this).attr("mcode")
    }))
}
...
SelectNewOwner = function(){
    $('.ChoseOwnerScreen').fadeOut(350);
    $.post('http://Sam_motels/LoadNewAdmin', JSON.stringify({
        source: $(this).attr("idx"),
        img: $(this).attr("resim"),
        mcode: SecilenMotelMCode
    }))
...
UpdateMotelData = function(){
    $.post('http://Sam_motels/UpdateAllData', JSON.stringify({
        name: $('#NameMotel').val(),
...
DeleteMotel = function(){
    ...
    $('#Left2').hide();
    $('#Left1').show();
    $.post('http://Sam_motels/DeleteMotel', JSON.stringify({
        mcode: SecilenMotelMCode
    }))
}
...
$(document).on('click', '#SetPlayerMotel', function(){
    $('#MotelAdminMenu').fadeOut(350);
    $.post('http://Sam_motels/SetPlayerCoord', JSON.stringify({
        mcode: SecilenMotelMCode
    }))
});
...
$(document).on('click', '#UpdateRoomPrice', function(){
    $('.roomeditpage').hide()
    $.post('http://Sam_motels/UpdateMotelRoomPrice', JSON.stringify({
        mcode: SecilenMotelMCode,
        roomid: SecilenMotelRoomID,
        price: $('#odafo').val(),
        yumurcak: YumurcakData
...
$(document).on('click', '#kickMotelRoom', function(){
    if(SecilenMotelRoomOwner !== 'No Owner'){
        $('.roomeditpage').fadeOut(350);
        $.post('http://Sam_motels/KickMotelRoom', JSON.stringify({
            mcode: SecilenMotelMCode,
            roomid: SecilenMotelRoomID,
            yumurcak: YumurcakData
        }))
    } else {
        $.post('http://Sam_motels/JsNotify', JSON.stringify({
            type: "error",
            title: Lang["Invalid"],
...
$(document).on('click', '#DeleteRoom', function(){
    $('.roomeditpage').hide()
    $.post('http://Sam_motels/DeleteMotelRoom', JSON.stringify({
        mcode: SecilenMotelMCode,
        roomid: SecilenMotelRoomID,
    }))
});
...
$(document).on('click', '#createRoom', function(){
    ...
    if (inputText1.startsWith("vector3") && odaInterior && inputText2 !== "") {
        $('.NewEditMenu').fadeOut(350);
        $.post('http://Sam_motels/CreateMotelRoom', JSON.stringify({
            price: inputText2,
...
$(document).on('click', '#CreateRoomPart', function(){
    ...
    if (inputText1.startsWith("vector3") && inputText3.startsWith("vector3") && inputText4.startsWith("vector3") && inputText2 !== "" && inputText7 !== "" && inputText5 !== "" && inputText6 !== "") {
        $('.NewEditMenu').fadeOut(350);
        $.post('http://Sam_motels/CreateMotelRoomTeleport', JSON.stringify({
            doorHash: inputText2,
...
$(document).on('click', '#enterRoomCoord', function(){
    $('.NewEditMenu').fadeOut(350);
    $.post('http://Sam_motels/EnterRoomCoord', JSON.stringify({}))
});
