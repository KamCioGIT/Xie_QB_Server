    ...
    window.addEventListener('message', (event) => {
		...
		switch(data.action) {
           ...
           case "open":
            ...
            $(".ic-liste").html("");
            $.post("https://sam_damage/checkItems", {},  function (data) {
...
$(document).on("click", ".com-ic-listx button" , function() {
    $.post("https://sam_damage/rev",  JSON.stringify(cacheid));
    Close();
});  
...
function handle() {
    ...
    $(".bone-item").droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post("https://sam_damage/checkTreatment", JSON.stringify({ bone: bone, area: w, item: item, cacheid: cacheid }),  function (data) {
...
$(document).on("click", ".treatment-supplies a" , function() {
    ...
    interval = null;
    $.post("https://sam_damage/close");
    $.post("https://sam_damage/startTreat", JSON.stringify(cachedTreat));
});

$(document).on("click", ".menu-item" , function() {
    $(".menu").hide();
    $.post('https://sam_damage/action', JSON.stringify({ type: $(this).data("type"), pid: cacheid }));
});
