...
const app = Vue.createApp({
    ...
    watch: {
        ...
        isChatTimeChecked: function () {
            localStorage.setItem("isChatTimeChecked", this.isChatTimeChecked);
        },
    ...
    methods: {
        ...
        initIsChatTimeChecked: function () {
            const stored = localStorage.getItem("isChatTimeChecked");
            if (stored === null) {
                return true;
            } else {
                return stored == 'true';
        ...
        initIsChatLineChecked: function () {
            const stored = localStorage.getItem("isChatLineChecked");
            if (stored === null) {
                return false;
            } else {
                return stored == 'true';
