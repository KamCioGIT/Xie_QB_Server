    ...
    t.extend(i.prototype, {
        init: function () {
            ...
            this.$el.addClass(function () {
                var t = [s];
                return n.fullscreen && t.push("fullscreen"),
                t.join(" ")
            }),
        ...
        next: function () {
            this.currentIndex = 0 === this.currentIndex ? this._slides.length - 1 : this.currentIndex - 1,
        ...
        addSlides: function (e) {
            ...
            return t.map(e.reverse(), function (t) {
                ...
                return e.style.backgroundImage = "url(" + t.src + ")",
                e.className = "slide",
                i.appendChild(e),
                e
            })
        ...
        buildScene: function (t) {
            ...
            n.fullscreen || (this.el.style.height = this.settings.height || t[this.currentIndex].height + "px"),
            ...
            if (p.isWrapped(this) ? (h = !1, n = 0, o = this, i = this) : (h = !0, n = 1, o = u ? arguments[0].elements || arguments[0].e : arguments[0]), o = f(o)) {
                ...
                case "stop":
                    m.each(o, function (a, b) {
                        ...
                        "finishAll" !== q || s !== !0 && !p.isString(s) || (m.each(m.queue(b, p.isString(s) ? s : ""), function (a, b) {
                                p.isFunction(b) && b()
...
(this, function (a) {
    ...
    e.prototype.init = function () {
        ...
        "detect" === o ? d(j, function (a) {
            e.css("background-image", "url(" + a + ")")
        }) : "none" !== o && e.css("background-image", "url(" + j + "." + o + ")"),
        "static" === l.css("position") && l.css("position", "relative"),
        l.prepend(e),
        "object" == typeof i ? (i.mp4 && (k += '<source src="' + i.mp4 + '.mp4" type="video/mp4">'), i.webm && (k += '<source src="' + i.webm + '.webm" type="video/webm">'), i.ogv && (k += '<source src="' + i.ogv + '.ogv" type="video/ogg">'), b = g.$video = a("<video>" + k + "</video>")) : b = g.$video = a('<video><source src="' + i + '.mp4" type="video/mp4"><source src="' + i + '.webm" type="video/webm"><source src="' + i + '.ogv" type="video/ogg"></video>');
        try {
            b.prop({
                autoplay: m.autoplay,
                loop: m.loop,
...
!function (jQuery, ytp) {
    jQuery.mbYTPlayer = {
                                ...
                                if (!YTPlayer.isInit) {
                                    ...
                                    new YT.Player(playerID, {
                                        ...
                                        events: {
                                            onReady: function (a) {
                                                YTPlayer.player = a.target,
                                                YTPlayer.isReady || (YTPlayer.isReady = YTPlayer.isPlayer && !YTPlayer.opt.autoPlay ? !1 : !0, YTPlayer.playerEl = YTPlayer.player.getIframe(), jQuery(YTPlayer.playerEl).unselectable(), $YTPlayer.optimizeDisplay(), YTPlayer.videoID = videoID, jQuery(window).off("resize.YTP_" + YTPlayer.id).on("resize.YTP_" + YTPlayer.id, function () {
        ...
        playNext: function () {
            var a = this.get(0);
            return a.checkForStartAt && (clearTimeout(a.checkForStartAt), clearInterval(a.getState)),
            a.videoCounter++,
        ...
        playPrev: function () {
            var a = this.get(0);
            return a.checkForStartAt && (clearInterval(a.checkForStartAt), clearInterval(a.getState)),
            a.videoCounter--,
        ...
        setVolume: function (a) {
            var b = this.get(0);
            return a || b.opt.vol || 0 != b.player.getVolume() ? !a && b.player.getVolume() > 0 || a && b.opt.vol == a ? b.isMute ? jQuery(b).YTPUnmute() : jQuery(b).YTPMute() : (b.opt.vol = a, b.player.setVolume(b.opt.vol), b.volumeBar && b.volumeBar.length && b.volumeBar.updateSliderVal(a)) : jQuery(b).YTPUnmute(),
            this
        },
        mute: function () {
            var a = this.get(0);
        ...
        toggleFilters: function (a) {
            return this.each(function () {
                var b = this;
                b.filtersEnabled ? (jQuery(b).trigger("YTPDisableFilters"), jQuery(b).YTPDisableFilters()) : (jQuery(b).YTPEnableFilters(), jQuery(b).trigger("YTPEnableFilters")),
            ...
            jQuery.contains(document, YTPlayer) ? (jQuery.mbYTPlayer.checkForStart(YTPlayer), void(YTPlayer.getState = setInterval(function () {
                        ...
                        if (YTPlayer.player.time = prog.currentTime, 0 == YTPlayer.player.getVolume() ? $YTPlayer.addClass("isMuted") : $YTPlayer.removeClass("isMuted"), YTPlayer.opt.showControls && (prog.totalTime ? YTPlayer.controlBar.find(".mb_YTPTime").html(jQuery.mbYTPlayer.formatTime(prog.currentTime) + " / " + jQuery.mbYTPlayer.formatTime(prog.totalTime)) : YTPlayer.controlBar.find(".mb_YTPTime").html("-- : -- / -- : --")), eval(YTPlayer.opt.stopMovieOnBlur) && (document.hasFocus() ? document.hasFocus() && !YTPlayer.hasFocus && -1 != YTPlayer.state && 0 != YTPlayer.state && (YTPlayer.hasFocus = !0, $YTPlayer.YTPPlay()) : 1 == YTPlayer.state && (YTPlayer.hasFocus = !1, $YTPlayer.YTPPause())), YTPlayer.controlBar && YTPlayer.controlBar.outerWidth() <= 400 && !YTPlayer.isCompact ? (YTPlayer.controlBar.addClass("compact"), YTPlayer.isCompact = !0, !YTPlayer.isMute && YTPlayer.volumeBar && YTPlayer.volumeBar.updateSliderVal(YTPlayer.opt.vol)) : YTPlayer.controlBar && YTPlayer.controlBar.outerWidth() > 400 && YTPlayer.isCompact && (YTPlayer.controlBar.removeClass("compact"), YTPlayer.isCompact = !1, !YTPlayer.isMute && YTPlayer.volumeBar && YTPlayer.volumeBar.updateSliderVal(YTPlayer.opt.vol)), 1 == YTPlayer.player.getPlayerState() && (parseFloat(YTPlayer.player.getDuration() - 1.5) < YTPlayer.player.getCurrentTime() || stopAt > 0 && parseFloat(YTPlayer.player.getCurrentTime()) > stopAt)) {
                            ...
                            if (YTPlayer.isEnded = !0, setTimeout(function () {
                                ...
                                return YTPlayer.player.loopTime = void 0, YTPlayer.preventTrigger = !0, jQuery(YTPlayer).YTPPause(), YTPlayer.state = 0, void YTPlayer.wrapper.CSSAnimate({
                                    opacity: 0
                                }, 500, function () {
                                    YTPlayer.controlBar && YTPlayer.controlBar.find(".mb_YTPPlaypause").html(jQuery.mbYTPlayer.controls.play);
            ...
            a.checkForStartAt = setInterval(function () {
                ...
                if (a.player.getDuration() > 0 && a.player.getCurrentTime() >= d && c) {
                    ...
                    if (e.time = a.player.time, jQuery(a).trigger(e), a.preventTrigger = !0, jQuery(a).YTPPause(), a.opt.mute || jQuery(a).YTPUnmute(), a.canTrigger = !0, a.opt.autoPlay) {
                        ...
                        a.player.pauseVideo(), a.isPlayer || (jQuery(a.playerEl).CSSAnimate({
                                opacity: 1
    ...
    jQuery.fn.optimizeDisplay = function () {
        ...
        if (b.optimizeDisplay) {
            ...
            d.height = "16/9" == b.ratio ? Math.ceil(9 * g.width / 16) : Math.ceil(3 * g.width / 4),
            d.marginTop =  - ((d.height - g.height) / 2),
            d.marginLeft =  - (g.width * (e / 2) / 100),
            d.height < g.height && (d.height = g.height + g.height * e / 100, d.width = "16/9" == b.ratio ? Math.floor(16 * g.height / 9) : Math.floor(4 * g.height / 3), d.marginTop =  - (g.height * (e / 2) / 100), d.marginLeft =  - ((d.width - g.width) / 2)),
            d.width += f,
            d.height += f,
            d.marginTop -= f / 2,
            d.marginLeft -= f / 2
...
!function (e) {
    e.fn.countdown = function (t, s) {
        function n() {
            eventDate = Date.parse(i.date) / 1e3,
            currentDate = Math.floor(e.now() / 1e3),
            eventDate <= currentDate && (s.call(this), clearInterval(interval)),
            ...
            seconds -= 60 * minutes,
            thisEl.find(".timeRefDays").text(1 == days ? "day" : "days"),
            thisEl.find(".timeRefHours").text(1 == hours ? "hour" : "hours"),
            thisEl.find(".timeRefMinutes").text(1 == minutes ? "minute" : "minutes"),
            thisEl.find(".timeRefSeconds").text(1 == seconds ? "second" : "seconds"),
            "on" == i.format && (days = String(days).length >= 2 ? days : "0" + days, hours = String(hours).length >= 2 ? hours : "0" + hours, minutes = String(minutes).length >= 2 ? minutes : "0" + minutes, seconds = String(seconds).length >= 2 ? seconds : "0" + seconds),
    ...
    t.fn.shuffleLetters = function (r) {
        ...
        return this.each(function () {
            ...
            function p(t) {
                ...
                s = a.slice(0);
                if (t > u)
                    return r.data("animated", !1), void n.callback(r);
                for (i = Math.max(t, 0); u > i; i++)
                    s[o[i]] = i < t + n.step ? e(l[o[i]], n.pool) : "";
                r.text(s.join("")),
                setTimeout(function () {
                    p(t + 1)
                }, 1e3 / n.fps)
...
jQuery(function (e) {
    e("body").html(),
    !0,
    e("#main-menu-caller").on("click", function () {
        $menuCaller = e(this),
    ...
    e(".menu").on("click", function (n) {
        n.stopPropagation(),
        n.preventDefault(),
        e("#main-menu").removeClass("activated"),
        e("#main-menu-caller").removeClass("lines-close")
    })
});
            ...
            getInline: function (n, i) {
                if (M(), n.src) {
                    ...
                    if (r.length) {
                        ...
                        a && a.tagName && (P || (S = o.hiddenClass, P = x(S), S = "mfp-" + S), O = r.after(P).detach().removeClass(S)),
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            getImage: function (n, i) {
                ...
                t.resizeImage(),
                n.hasSize ? (A && clearInterval(A), n.loadError ? (i.addClass("mfp-loading"), t.updateStatus("error", s.tError.replace("%url%", n.src))) : (i.removeClass("mfp-loading"), t.updateStatus("ready")), i) : (t.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, i.addClass("mfp-loading"), t.findImageSize(n)), i)
            }
        }
    });
    var N,
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function (n) {
                ...
                return W() ? s["-moz-transform"] = s.transform = "translate(" + o.left + "px," + o.top + "px)" : (s.left = o.left, s.top = o.top),
                s
            }
        }
    });
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function () {
                ...
                n && n.enabled ? (r += " mfp-gallery", I(p + o, function () {
                        ...
                        if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                            ...
                            t.isIE7 && (x("b", o[0], !1, !0), x("a", o[0], !1, !0), x("b", r[0], !1, !0), x("a", r[0], !1, !0)),
                            t.container.find('.mfp-bottom-bar').append(o.add(r))
                        }
                    }), I(f + o, function () {
...
!function (e, t, i, r) {
    ...
    function o(t, i) {
        this.$element = e(t),
        this.url = n(i),
        this.delay = i.delay ? parseInt(i.delay) : 0,
        this.init()
    }
    function n(e) {
    ...
    o.prototype.resize = function () {
        if (this.$player) {
            ...
            o = {};
            o.width = e + e * i / 100,
            o.height = Math.ceil(9 * e / 16),
            o.marginTop =  - ((o.height - t) / 2),
            o.marginLeft =  - (e * (i / 2) / 100),
            o.height < t && (o.height = t + t * i / 100, o.width = Math.floor(16 * t / 9), o.marginTop =  - (t * (i / 2) / 100), o.marginLeft =  - ((o.width - e) / 2)),
            o.width += r,
            o.height += r,
            o.marginTop -= r / 2,
            o.marginLeft -= r / 2,
    ...
    o.prototype.destroy = function () {
        this.$element.unbind(a),
        this.$player && this.$player.unbind(a),
        delete e[a].lookup[this.index],
    ...
    e(i).ready(function () {
        e(t).bind("resize." + a, function () {
            for (var t, i = e[a].lookup.length, r = 0; i > r; r++)
                t = e[a].lookup[r], t && (clearTimeout(t.timer), t.timer = setTimeout(t.resize(), 250))
        })
    })
}
...
("undefined" != typeof window ? window : this, function (e, t) {
    ...
    function s(e) {
        var t = {};
        for (var n in e)
            "webkitMovementX" !== n && "webkitMovementY" !== n && (t[n] = o(e[n]) ? c(e[n], e) : e[n]);
        return t
    }
    function l(e) {
        function t(t) {
        ...
        function n(e) {
            for (_ = 0; _ < et.length; _++)
                B = et[_], i(B) ? O[(e ? "add" : "remove") + "EventListener"].call(O, B, S, !1) : o(B) ? S = B : O = B
        }
        function r() {
            L(A),
            A = I(r),
            ...
            e.running && !q && (e.dt = (z = +new Date) - e.now, e.millis += e.dt, e.now = z, t(e.update), Z && (e.retina && (e.save(), e.scale(V, V)), e.autoclear && e.clear()), t(e.draw), Z && e.retina && e.restore()),
            q = ++q % e.interval
        }
        function c() {
            O = J ? e.style : e.canvas,
            D = J ? "px" : "",
            Y = e.width,
            j = e.height,
            e.fullscreen && (j = e.height = v.innerHeight, Y = e.width = v.innerWidth),
            e.retina && Z && V && (O.style.height = j + "px", O.style.width = Y + "px", Y *= V, j *= V),
            O.height !== j && (O.height = j + D),
            O.width !== Y && (O.width = Y + D),
            K && t(e.resize)
        }
        function l(t, n) {
            return N = n.getBoundingClientRect(),
            t.x = t.pageX - N.left - (v.scrollX || v.pageXOffset),
            t.y = t.pageY - N.top - (v.scrollY || v.pageYOffset),
            e.retina && Z && V && (t.x *= V, t.y *= V),
            t
        }
        function f(t, n) {
            return l(t, e.element),
            n = n || {},
            n.ox = n.x || t.x,
            n.oy = n.y || t.y,
            n.x = t.x,
        ...
        function g(n) {
            for (n = d(n), M = (X = et.indexOf(W = n.type)) - 1, e.dragging = /down|start/.test(W) ? !0 : /up|end/.test(W) ? !1 : e.dragging; M; )
                i(et[M]) ? t(e[et[M--]], n) : i(et[X]) ? t(e[et[X++]], n) : M = 0
        }
        function p(n) {
            F = n.keyCode,
            H = "keyup" == n.type,
    ...
    for (var f, d, g = "E LN10 LN2 LOG2E LOG10E PI SQRT1_2 SQRT2 abs acos asin atan ceil cos exp floor log round sin sqrt tan atan2 pow max min".split(" "), p = "__hasSketch", m = Math, h = "canvas", y = "webgl", x = "dom", w = t, v = e, b = [], E = {
            ...
            create: function (e) {
                ...
                f = e.element = e.element || w.createElement(e.type === x ? "div" : "canvas"),
                d = e.context = e.context || function () {
                    switch (e.type) {
                    case h:
                ...
                (),
                (e.container || w.body).appendChild(f),
                k.augment(d, e)
            },
        ...
        }, P = ["ms", "moz", "webkit", "o"], T = self, A = 0, S = "AnimationFrame", O = "request" + S, R = "cancel" + S, I = T[O], L = T[R], N = 0; N < P.length && !I; N++)
        I = T[P[N] + "Request" + S], L = T[P[N] + "Cancel" + S];
