SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        if (mechanic.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">没有在线机械师.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (taxi.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">没有在线出租车.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (police.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">没有值班警察.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (ambulance.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">没有值班医生.</div></div>'
            $(".lawyers-list").append(element);
        }
    } else {
        $(".lawyers-list").append('<h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; border-top-left-radius: .5vh; border-top-right-radius: .5vh; width:100%; display:block; background-color: rgb(42, 137, 214);">Lawyers (' + lawyers.length + ')</h1>');

        var element = '<div class="lawyer-list"><div class="no-lawyers">没有执业律师.</div></div>'
        $(".lawyers-list").append(element);

        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(155, 15, 120);">Real Estate (' + realestate.length + ')</h1>');

        var element = '<div class="lawyer-list"><div class="no-lawyers">没有房地产经纪人.</div></div>'
        $(".lawyers-list").append(element);

        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(0, 204, 102);">汽修 (' + mechanic.length + ')</h1>');

        var element = '<div class="lawyer-list"><div class="no-lawyers">没有可用的机制.</div></div>'
        $(".lawyers-list").append(element);

        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 190, 27);">出租车 (' + taxi.length + ')</h1>');

        var element = '<div class="lawyer-list"><div class="no-lawyers">没有出租车.</div></div>'
        $(".lawyers-list").append(element);
        
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(0, 102, 255);">LSPD (' + police.length + ')</h1>');

        var element = '<div class="lawyer-list"><div class="no-lawyers">没有政策可用.</div></div>'
        $(".lawyers-list").append(element);
        
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 0, 0);">LSFD (' + ambulance.length + ')</h1>');

        var element = '<div class="lawyer-list"><div class="no-lawyers">没有救护人员可用.</div></div>'
        $(".lawyers-list").append(element);
    }
}
                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "手机", "您开启了匿名电话!");
                        }
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "手机", "您正在通话中!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "手机", "您拨打的电话正在通话中");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "手机", "您拨打的电话无法接通!");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "手机", "你不能打电话给你自己!");
        }
    });
});
