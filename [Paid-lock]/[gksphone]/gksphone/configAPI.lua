...
Cfg.TebexTransactionID = "tbx-81730923a5093-5dab1c" --- Required for PlayTube and Music app. (Example : tbx-....)
...
Cfg.MediaServices   = "gkshop" --- ## gkshop(picture,audio,video), discord(picture,audio,video), imgur(only picture), imgbb(only picture)
Cfg.MediaToken      = "afd903c9-50b7-4416-830f-5b6a59bbf4ec"        --- ## Media Service Token (if you are using discord leave this blank)
