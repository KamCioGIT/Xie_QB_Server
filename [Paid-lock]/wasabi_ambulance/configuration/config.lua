...
Config.RespawnTimer = 1--5 * minutes -- Time before optional respawn
...
Config.Locations = {
    Pillbox = {
        RespawnPoint = { -- When player dies and bleeds out; they will revive at nearest hospital; Define the coords of this hospital here.
            coords = vec3(-1828.86, -346.76, 49.46),
            heading = 332.22
        },

        Blip = {
            Enabled = true,
            Coords = vec3(-1854.97, -379.67, 48.48),
            Sprite = 61,
            Color = 2,
            Scale = 1.0,
            String = '洛圣都医院'
        ...
        clockInAndOut = {
            ...
            coords = vec3(-1851.17, -335.14, 49.45), -- Location of where to go on and off duty(If not using target)
            ...
            target = {
                ...
                label = '值班/下班',
                coords = vec3(-1851.17, -335.14, 49.45),
                heading = 337.07,
                width = 2.0,
                length = 1.0,
                minZ = 43.28-0.9,
        ...
        PersonalLocker = {
            ...
            coords = vec3(-1854.82, -331.31, 49.45), -- Location of where to access personal locker (If target is disabled)vector3(-1854.82, -331.31, 49.45)
            label = '[E] - 访问个人储物柜', -- Text to display(If not using target)
            distance = 1.5, -- Distance to display text UI(If not using target)
            target = {
                enabled = false, -- If enabled, the location and distance above will be obsolete
                label = '个人储物柜',
                coords = vec3(-1854.82, -331.31, 49.45),
                heading = 70.18,
                width = 2.0,
                length = 1.0,
                minZ = 43.28-0.9,
        ...
        CheckIn = { -- Hospital check-in
            ...
            Ped = 's_m_m_scientist_01', -- Check in ped
            Coords = vec3(-1850.94, -339.55, 49.44-0.9), -- Coords of ped vector3(-1850.94, -339.55, 49.44)
            Distance = 4.85, -- Distance to show textUI (If target is not enabled below)
            ...
            Target = {
                enabled = true, -- Enable Target? (Can be customized in wasabi_bridge/customize/cl_customize.lua the target system)
                label = '住院',
                coords = vec3(-1850.94, -339.55, 49.44),
                heading = 63.26,
                distance = 5.0,
                width = 2.0,
                length = 1.0,
            ...
            HospitalBeds = {
  --              { coords = vec3(332.62, -587.17, 42.84), heading = 160.0, model = 1631638868 },
                { coords = vec3(-1862.7, -334.29, 49.19), heading = 322.0, model = 1570477186 },--vector4(-1862.7, -334.29, 50.19, 322.94)
                { coords = vec3(-1865.92, -332.13, 50.19), heading = 327.0, model = 1570477186 },--vector4(-1865.92, -332.13, 50.19, 327.82)
                { coords = vec3(-1868.66, -329.69, 50.19), heading = 317.0, model = 1570477186 },--vector4(-1868.66, -329.69, 50.19, 317.65)
